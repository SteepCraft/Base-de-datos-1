...
BEGIN
  ...
  FOR t IN (
    ...
    WHERE table_name IN (
      'DETALLE_VENTA','DETALLE_COMPRAS','SUMINISTROS','INVENTARIO',
...
CREATE TABLE compras (
  ...
  id_proveedor  VARCHAR2(20),         -- FK -> proveedor.id
  tot_compras   NUMBER(12,2)
);
