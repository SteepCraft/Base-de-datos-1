      ...
      <div className='flex flex-col justify-between gap-4 mb-6 sm:flex-row'>
        ...
        <div className='flex gap-2'>
          <button
            ...
            className='inline-flex items-center px-4 py-2 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'
